# Incident Detail — Page Specification

**Route:** `/incidents/:incidentId`  
**Reference slug:** `04-incident-detail`

## Purpose

Show the complete operational record, evidence, commitments, communications and next actions for one incident.

## Authoritative mockups

- `mockups/dark/desktop/04-incident-detail.png`
- `mockups/dark/tablet/04-incident-detail.png`
- `mockups/dark/mobile/04-incident-detail.png`
- `mockups/light/desktop/04-incident-detail.png`
- `mockups/light/tablet/04-incident-detail.png`
- `mockups/light/mobile/04-incident-detail.png`

## Required sections

- Incident header and status
- Tabs
...
Stack evidence and timeline sections; keep incident status and primary next action near the top.
